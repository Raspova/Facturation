<script>
    ...
    // let wallet_colorsSeg = "#771e14f2";
    //GREEN
    // let wallet_colorsPrim = "#358c1d";
    // let wallet_colorsSeg = "#286617";
...
<button class="button" disabled>
    <span class="button__text">
      ...
      <svg class="button__svg"  viewBox="0 0 600 600">
      <defs>
        <clipPath id="myClip">
      ...
      <g id="wallet">
        <path d="M478,288.23h-337A28.93,28.93,0,0,0,112,317.14V546.2a29,29,0,0,0,28.94,28.95H478a29,29,0,0,0,28.95-28.94h0v-229A29,29,0,0,0,478,288.23Z" fill={wallet_colorsPrim} stroke="#323c44" stroke-miterlimit="10" stroke-width="14" />
        <path d="M512.83,382.71H416.71a28.93,28.93,0,0,0-28.95,28.94h0V467.8a29,29,0,0,0,28.95,28.95h96.12a19.31,19.31,0,0,0,19.3-19.3V402a19.3,19.3,0,0,0-19.3-19.3Z" fill={wallet_colorsPrim} stroke="#323c44" stroke-miterlimit="10" stroke-width="14" />
        <path d="M451.46,435.79v7.88a14.48,14.48,0,1,1-29,0v-7.9a14.48,14.48,0,0,1,29,0Z" fill={wallet_colorsPrim} stroke="#323c44" stroke-miterlimit="10" stroke-width="14" />
        <path d="M147.87,541.93V320.84c-.05-13.2,8.25-21.51,21.62-24.27a42.71,42.71,0,0,1,7.14-1.32l-29.36-.63a67.77,67.77,0,0,0-9.13.45c-13.37,2.75-20.32,12.57-20.27,25.77l.38,221.24c-1.57,15.44,8.15,27.08,25.34,26.1l33-.19c-15.9,0-28.78-10.58-28.76-25.93Z" fill={wallet_colorsSeg} />
