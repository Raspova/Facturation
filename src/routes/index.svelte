<script>
  ...
  <main>
    ...
    <div class="panel" id="div_id1" on:click={statutLink("admin")} bind:this={panel1} class:selected="{statusActif === 'admin'}"> <h2>Admin</h2></div>
     <div class="panel active" id="div_id2" on:click={statutLink("prof")} bind:this={panel2} class:selected="{statusActif === 'prof'}"> <h2>Enseignant</h2></div>
     <div class="panel" id="div_id3"on:click={statutLink("student")} bind:this={panel3} class:selected="{statusActif === 'student'}"> <h2>Etudiant</h2></div>
